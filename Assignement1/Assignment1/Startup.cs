...
namespace Assignment1
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.AddPolicy("AdminRole", a => a.RequireAuthenticatedUser().RequireClaim("Role", "Admin"));
                options.AddPolicy("HorsensCity", a => a.RequireAuthenticatedUser().RequireClaim("City", "Horsens"));
